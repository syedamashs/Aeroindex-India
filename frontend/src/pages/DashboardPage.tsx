    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard
          ...
          value={formatNumber(getObservations().length) + '+'}
          sublabel={`${formatNumber(filteredObs.length)} filtered`}
        ...
        <KpiCard
          ...
          sublabel={`${formatNumber(pipeline.validObservations)} valid records`}
