        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex items-center gap-3 bg-navy-900/80 p-3.5 rounded-2xl border border-navy-700">
            ...
            <div className="text-xs">
              ...
              <p className="text-emerald-400 font-mono font-bold text-sm">Active SQLite Store</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          {PIPELINE_STAGES.map((stage, i) => {
            ...
            return (
              <div
                key={stage.label}
                className="p-4 rounded-xl bg-slate-50/70 border border-slate-200/80 flex flex-col justify-between group hover:bg-white hover:shadow-md transition-all relative"
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded bg-navy-100 text-navy-800">
                      0{i + 1}
                    </span>
                    <Icon className="w-4 h-4 text-navy-600 group-hover:text-accent-500 transition-colors" />
                  </div>
                  <div>
