...
def test_simple_known_laspeyres_example():
    result = calculate_laspeyres_index(
        [100, 200],
        [110, 220],
        [2, 1],
    )
...
def test_equal_base_weights():
    ...
    assert result.relative == Decimal("1.066666666666666666666666667")


def test_unequal_base_weights():
    result = calculate_laspeyres_index(
        [100, 200],
        [120, 210],
        [3, 1],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([100], [110], [None], "base_weight_missing_at_index_0"),
        ([100], [110], [-1], "base_weight_negative_at_index_0"),
        ([100], [110], ["invalid"], "base_weight_invalid_at_index_0"),
    ],
)
def test_invalid_inputs_are_not_checkable(base, current, weights, reason):
    result = calculate_laspeyres_index(base, current, weights)
...
def test_zero_total_denominator():
    result = calculate_laspeyres_index(
        [100, 200],
        [110, 220],
        [0, 0],
...
def test_multiple_independent_datasets():
    ...
    results = [
        calculate_laspeyres_index(base, current, weights)
