...
month_mult = [
    1.0, 1.024, 0.998, 1.061, 1.094, 1.112,
    1.089, 1.127, 1.105, 1.082, 1.061, 1.044,
]
...
for route in route_info:
    ...
    for month_index in range(12):
        ...
        while travel_month > 12:
            travel_month -= 12
            year += 1
        for day in range(1, calendar.monthrange(year, travel_month)[1] + 1):
            travel_day = date(year, travel_month, day)
